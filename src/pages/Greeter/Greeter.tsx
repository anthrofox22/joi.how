  ...
  return (
    <div className="GreeterPage">
      ...
      <p>
        ...
        well as select some porn to help with &quot;motivation&quot;. It&apos;s all pulled from <a href="https://e621.net">E621.net</a>, <a href="https://www.redgifs.com">redgifs.com</a>, <a href="https://github.com/stashapp/stash">your own Stash server</a> or
